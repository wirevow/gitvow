...
- **Session notes carry less from Gemini and Cursor.** The stated plan and tool counts come from the transcript, and gitvow reads Claude Code's and Codex's transcript formats. For Gemini and Cursor the note records the commit, the trailers, the snapshot and the attribution, and leaves the plan empty until their transcript formats are added.
